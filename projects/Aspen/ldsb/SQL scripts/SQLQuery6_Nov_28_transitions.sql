...
select top 10 * from [ASPEN].[AspenDB-LDSB-PD].[dbo].student where STD_OID = ''

select * from [ASPEN].[AspenDB-LDSB-PD].[dbo].student where STD_FIELDA_081 = '1'

select top 100 * from [ASPEN].[AspenDB-LDSB-PD].[dbo].person where PSN_NAME_LAST = 'Cowdy' and PSN_NAME_FIRST = 'Remington'
...
select top 10 * from [ASPEN].[AspenDB-LDSB-PD].[dbo].student_alert where alr_std_oid = 'std01000046200'

select * from [ASPEN].[AspenDB-LDSB-PD].[dbo].student_alert where alr_alert_description like '%Dibels%'
and alr_std_oid = 'STD000000GKPkl'
...
-- find this student
select top 10 * from [ASPEN].[AspenDB-LDSB-PD].[dbo].student where STD_PSN_OID = 'psn01000133446'
...
select * from [ASPEN].[AspenDB-LDSB-PD].[dbo].ref_code where rcd_rtb_oid = 'RTB000000T8RRP'

select * from [ASPEN].[AspenDB-LDSB-PD].[dbo].ref_table where RTB_OID = 'RTB000000T8RRP'

select * from [ASPEN].[AspenDB-LDSB-PD].[dbo].ref_table where RTB_USER_NAME like '%Dibels%'
