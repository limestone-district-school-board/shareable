  ...
  for (const row of rows) {
	...
	if(cells[18] !== null && cells[18] !== undefined && cells[18] !== '')
		switch (transportationMode.trim()) {
			...
			break;
			default:
			 transportationMode = cells[18].trim();
		}
	
	if(secondCell != '483419')
		continue;
	...
	InboundWriteStream.write(firstCell + ',' + '2023' + ',' + compareValue[secondCell] + ',' + 'Inbound' + ',' + convertedOutboundStartDate + ','
	+ cells[2] + ',' +  cells[7] + ',' +  cells[3] + ',' + cells[4] + ',' + cells[6] +
	',' + convertedOutboundEndDate + ',' +  transportationMode + '\n');
	
	//console.log(firstCell + ',' + '2023' + ',' + compareValue[secondCell] + ',' + 'Inbound' + ',' + convertedOutboundStartDate + ','
	//+ cells[7] + ',' +  cells[2] + ',' +  cells[3] + ',' + cells[4] + ',' + cells[6] +
	//',' + convertedOutboundEndDate + ',' +  cells[18] + '\n')
	
	OutboundWriteStream.write(firstCell + ',' + '2023' + ',' + compareValue[secondCell] + ',' + 'Outbound' + ',' + convertedInboundStartDate + ','
	+ cells[10] + ',' +  cells[15] + ',' +  cells[11] + ',' + cells[12] + ',' + cells[14] +
	',' + convertedInboundEndDate + ',' +  transportationMode + '\n');
