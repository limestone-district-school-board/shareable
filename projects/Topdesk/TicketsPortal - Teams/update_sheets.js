...
// ticketDataCollection is a group of all ticket, open and closed, over the past week.
exports.updateSheets = function(ticketCollectionData) {

	console.log("Ticket data: " + ticketCollectionData);
}
...
async.series([
    ...
    function addNewWorksheet(step) {
        ...
        var newsheet_options = {
            "title": "Todays open topdesk tickets",
            "rowCount": 500,
            "colCount": 500,
            "headers": headings
        };
