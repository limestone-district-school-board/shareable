...
SELECT '"' + 'LDSB' + '"'					AS BOARDCODE
  ...
  AND a.school_code in ('SVIEW','ENTPR','TAMWH','SELBY')
  ...
  AND a.school_code in ('SVIEW','ENTPR','TAMWH','SELBY','NAPDI')
...
c.school_year = e.school_year
  ...
  AND c.school_code in ('SVIEW','ENTPR','TAMWH','SELBY','NAPDI')
